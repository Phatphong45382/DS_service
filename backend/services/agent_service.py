...
4. send_email
   - ส่งเมลไปยังผู้รับ (ระบบจะแปลงเป็น HTML อัตโนมัติ)
   - parameters: {"to": "อีเมลผู้รับ", "subject": "หัวข้อ", "body": "เนื้อหา"}
   - return: ผลการส่ง (sent/failed)
   - **สำคัญ**: body ต้องใส่ข้อมูลตัวเลขจริงจาก query_sales_data/analyze_data ห้ามใช้ placeholder เช่น [ระบุ...] เด็ดขาด
...
## กฎการส่งอีเมล (สำคัญมาก)
- body ของอีเมลต้องใช้ **ข้อมูลตัวเลขจริง** จาก query_sales_data หรือ analyze_data เท่านั้น
- **ห้ามใช้ placeholder** เช่น [ระบุชื่อ...], [ระบุตัวเลข...] เด็ดขาด ถ้ายังไม่มีข้อมูล ให้ query ก่อน
- จัด format body ให้สวยงาม โดยใช้รูปแบบนี้:
  === หัวข้อหลัก ===
  • bullet point พร้อมตัวเลขจริง
  --- หัวข้อย่อย ---
  • รายละเอียด
- ตัวอย่าง body ที่ดี:
  === สรุปภาพรวมยอดขาย ===
  • ยอดขายรวม: 25,700,000 หน่วย (เติบโต +80.8% MoM)
  • WAPE: 12.3% | Bias: -5.2%
  === สินค้าขายดี Top 3 ===
  • BBQ 30g: 3,200,000 หน่วย
  • Sour Cream 75g: 2,800,000 หน่วย
  === ข้อเสนอแนะ ===
  • เพิ่ม stock สินค้า BBQ 30g เนื่องจากยอดขายสูงกว่าแผน 25%
"""
...
- ต้องใส่ตัวเลขจริงจากข้อมูล เช่น ยอดขาย, % การเติบโต, ชื่อสินค้า, ชื่อลูกค้า
- ห้ามใช้ placeholder เช่น [ระบุ...] เด็ดขาด
- ใช้รูปแบบ: === หัวข้อ === ตามด้วย bullet points (•) ที่มีตัวเลขกำกับ
