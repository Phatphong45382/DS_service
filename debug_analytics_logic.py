...
# Mock settings and services for standalone run
# We assume we are running this from c:\work\pre_sale\DS_service\Malee so python path is set
...
def run_debug():
    ...
    try:
        ...
        for row in rows:
            ...
            print(f"Date: {date_str} -> {parsed_date} | Actual: {actual}")

        print(f"\nSummary in first 100 rows:")
