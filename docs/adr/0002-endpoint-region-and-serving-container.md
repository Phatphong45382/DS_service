...
- **The PyTorch deep-learning container in ap-southeast-7** — the only container family published there, but it does not fix the serverless gap either, and it was measured to be unworkable: endpoint creation never completed.
